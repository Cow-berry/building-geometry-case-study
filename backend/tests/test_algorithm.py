...
from app.geometry.domain import CEM, PEM, Constraint, MassingResult, SitePolygon
...
@pytest.mark.parametrize("constraints", [modest_constraints, tower_constraints, infeasible_constraints])
